...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/bg.png", __ASSET__assets_bg_png);
		...
		className.set ("assets/gibs.png", __ASSET__assets_gibs_png);
		type.set ("assets/gibs.png", AssetType.IMAGE);
		className.set ("assets/map - Copy.png", __ASSET__assets_map___copy_png);
		...
		className.set ("assets/pusher.png", __ASSET__assets_pusher_png);
		type.set ("assets/pusher.png", AssetType.IMAGE);
		className.set ("assets/tiles - Copy.png", __ASSET__assets_tiles___copy_png);
...
@:keep @:bind #if display private #end class __ASSET__assets_bg_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_gibs_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_map___copy_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_pusher_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_tiles___copy_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/bg.png") #if display private #end class __ASSET__assets_bg_png extends lime.graphics.Image {}
@:image("assets/crate.png") #if display private #end class __ASSET__assets_crate_png extends lime.graphics.Image {}
@:image("assets/elevator.png") #if display private #end class __ASSET__assets_elevator_png extends lime.graphics.Image {}
@:image("assets/gibs.png") #if display private #end class __ASSET__assets_gibs_png extends lime.graphics.Image {}
@:image("assets/map - Copy.png") #if display private #end class __ASSET__assets_map___copy_png extends lime.graphics.Image {}
...
@:image("assets/pusher.png") #if display private #end class __ASSET__assets_pusher_png extends lime.graphics.Image {}
@:image("assets/tiles - Copy.png") #if display private #end class __ASSET__assets_tiles___copy_png extends lime.graphics.Image {}
